...
- Config has three fields: `mode` (enforce/audit), `rejectOnMissingSNI`, `rejectOnMissingHost`.
...
- Config struct has three fields: `mode`, `rejectOnMissingSNI`, `rejectOnMissingHost`.
